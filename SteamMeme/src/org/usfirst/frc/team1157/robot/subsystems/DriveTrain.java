...
public class DriveTrain extends Subsystem {
    ...
    // if (joystick2.getTwist() > 0.1 || joystick2.getTwist() < -0.1 ||
    // joystick2.getX() > 0.1
    // || joystick2.getX() < -0.1 || joystick2.getY() > 0.1 || joystick2.getY()
    // < -0.1) {
    // robotDrive.mecanumDrive_Cartesian(joystick2.getX() * speedDamp,
    // joystick2.getY() * speedDamp,
